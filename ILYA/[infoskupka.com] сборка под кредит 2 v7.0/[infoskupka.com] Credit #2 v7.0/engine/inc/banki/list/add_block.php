...
//-------------------------------------------------====
echoheader( "<i class=\"fa fa-home position-left\"></i><span class=\"text-semibold\">Добавление блока</span>","<a href=\"$PHP_SELF?mod=banki\">Каталог банков 7.0</a> / <a href=\"$PHP_SELF?mod=banki&do=blocks\">Блоки</a>" );
...
if( isset( $_POST['submit'] ) )
	{
		...
		$db->query( "INSERT INTO ".PREFIX."_banki_options (`type`,`options`,`sort`) VALUES ('blocks','{$Options}','1')" );
...
<div style=\"padding: 20px;\">
		...
		else
	{
		...
		$AllowCats = $Banki->SelectCategory( array( "all" ), "", "", "", true );
