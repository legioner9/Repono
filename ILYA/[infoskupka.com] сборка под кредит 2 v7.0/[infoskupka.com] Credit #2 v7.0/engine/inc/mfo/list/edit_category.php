...
echoheader( "<i class=\"fa fa-home position-left\"></i><span class=\"text-semibold\">Редактирование категории</span>","<a href=\"$PHP_SELF?mod=mfo\">МФО 7.0</a> / <a href=\"$PHP_SELF?mod=mfo&do=category\">Категории</a>" );
...
<div style=\"padding: 20px;\">
	<a href=\"$PHP_SELF?mod=mfo&do=category\" class=\"btn bg-slate-600 btn-sm btn-raised legitRipple\" style=\"margin-right:5px;\">Список категорий<a/>
</div>";
					}
						else
					{
						...
						$opisanie = $Mfo->DB['category'][ $id ]['opisanie'];
						$opisanie_up = $Mfo->DB['category'][ $id ]['opisanie_up'];
	...
	<div class="panel-body">
		...
		<div class="form-group">
			<label class="control-label col-sm-2">Иконка:</label>
				<div class="col-sm-10">
					<input type="text" name="icon" value="{$icon}" class="form-control width-700 position-left"  />
				</div>
		</div>
		<div class="form-group">
