...
echoheader( "<i class=\"fa fa-home position-left\"></i><span class=\"text-semibold\">Категории</span>","<a href=\"$PHP_SELF?mod=mfo\">Каталог МФО 7.0</a> / <a href=\"$PHP_SELF?mod=mfo&do=category\">Категории</a>" );

$list = "";	
if( count( $Mfo->DB['category'] ) > 0 )
	{
		
		$list .= $Mfo->ReturnAdminCat();
	}
		else
	{
...
<form name="category" method="post" action="" onsubmit="SetFormSubmit( 'category' ); return false;">
	...
	<div class="panel-footer hidden-xs">
		...
		<a class="btn bg-teal btn-sm btn-raised position-left legitRipple" href="$PHP_SELF?mod=mfo&do=add_category" />Добавить категорию</a>
		</ul>
		</div>
