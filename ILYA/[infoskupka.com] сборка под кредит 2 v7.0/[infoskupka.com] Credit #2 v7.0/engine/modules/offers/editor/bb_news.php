...
$startform = "KatalogStory"; 
$addform = "document.KatalogPost";

$smileList = "<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" width=\"100%\"><tr>";
...
foreach( $smilies as $smile )
	{
		$i++;
		$smile = trim( $smile );
		$smileList .= "<td style=\"padding:2px;\" align=\"center\"><a href=\"#\" onclick=\"dle_smiley(':{$smile}:'); return false;\"><img style=\"border: none;\" alt=\"{$smile}\" src=\"".$config['http_home_url']."engine/data/emoticons/{$smile}.png\" /></a></td>";
		if( $i % 4 == 0 && $i < $count_smilies ) $smileList .= "</tr><tr>";
	}
